...
Đã kiểm trực tiếp `data/checkpoints/`: mỗi trạm chỉ có một JPG, `classes.json` và `cvat-labels.json`. Hai JSON định nghĩa lớp để tạo task CVAT, **không chứa mask đã vẽ**. Thư mục này là đầu vào sáu checkpoint, không phải ZIP bài làm. Xem [phiếu quy tắc và danh sách export checkpoint](https://github.com/duy12345-6789/K4-L2-Day05-LENGOCNAM-2A202602060-Segmentation/blob/main/guideline-mini-sheet.md).
